...
Better-SUS-Bot WAS a Bot made to rewrite all the mistakes made in [SUS-Bot](https://github.com/plastik-flasche/SUS-bot) by [Plastik-Flasche](https://github.com/plastik-flasche) like 
```js 
if(variable === undefined) // has been fixed
```
